$(document).ready(function() {
	...
	$(".lockscreen-box .user_signin").on("click", function() {
		$(".sign-in").show();
		$(this).remove();
		var newUrl = $('#tempFallbackHolder').text();
		$(".user").hide().find("img").attr('src', newUrl);
		$(".user").show();
		return false;
	});
	/* END LOCK SCREEN */
...
function x_navigation() {
	...
	$('body').on('click', '.x-navigation-control', function() {
	...
	$("body").on('click', '.x-navigation-minimize', function() {
	...
	$("body").on('click', '.x-navigation li > a', function() {
